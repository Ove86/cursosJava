    ...
    <>
      ...
      <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded bg-white'>
        <form>
          ...
          <input type="submit" value="Iniciar Sesión" className="bg-indigo-700 w-full py-3 px-10 rounded-xl text-white uppercasse font-bold mt-5 hover:bg-indigo-500 hover:cursor-pointer md:w-auto" />
        </form>
